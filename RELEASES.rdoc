...
== Bug Fixes
* Fix support for external proxies set via rs_agent:http_proxy tag on Linux.
* Additional fix for vSphere stuck in booting issues if hypervisor and instance time are mismatched.
